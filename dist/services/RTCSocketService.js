...
var RTCSocketService = /** @class */ (function () {
    ...
    RTCSocketService.prototype.allUsers = function () {
    ...
    RTCSocketService.prototype.scenario1 = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, "My message"];
            });
        });
    };
    /**
    ...
    __decorate([
        (0, socketio_1.Broadcast)("all users")
    ], RTCSocketService.prototype, "allUsers", null);
    __decorate([
    ...
    __decorate([
        (0, socketio_1.Input)("input:scenario1"),
        (0, socketio_1.Broadcast)("output:scenario1")
    ], RTCSocketService.prototype, "scenario1", null);
